...
export default function ProfilePage({profileClicked, editRoster, userPage, deleteFav, allFavs, allSports, signedIn}) {
    ...
    const renderFavs = allFavs.map((fav) => <UserSportsList 
    userPage={userPage} editRoster={editRoster} team={fav.team} 
    roster={fav.team.roster} key={fav.id} deleteFav={deleteFav} fav={fav} />)
